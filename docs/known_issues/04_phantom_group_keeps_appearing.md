...
Group deleted from Boss layout but still appears in player apps.
...
A group deleted from IPTVBoss layout continues to appear in player apps despite successful output and updates.
